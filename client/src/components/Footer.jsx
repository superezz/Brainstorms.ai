    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        >
          ...
          >
            <img src={logo} alt="img" className="h-9 w-9 object-contain" />
            <span
          ...
          <p className="text-sm text-gray-300 max-w-sm">
            Brainstorm AI helps students generate exam-focused notes, revision
            materials, diagrams, and printable PDFs using AI.
          </p>
        </motion.div>
        <div className="text-center">
          <h1 className="text-sm font-semibold text-white mb-4 cursor-pointer">
            Quick Links
          </h1>
