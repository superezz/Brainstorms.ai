...
function Navbar() {
  ...
  return (
    <motion.div
      ...
      className="relative z-20 mx-6 mt-6 rounded-2xl bg-gradient-to-br from-black/90 via-black/80 to-black/90 backdrop-blur-2xl border border-white/20 shadow-[0_22px_55px_rgba(0,0,0,0.75)] flex items-center justify-between px-8 py-4"
    >
      <div className="flex items-center gap-3">
        <img src={logo} alt="Brainstorms " className="w-9 h-9" />
        <span className="text-lg hidden md:block font-semibold text-white">
          {" "}
          Brainstorms<span className="text-gray-400">.ai</span>
        </span>
      </div>
          ...
          <AnimatePresence>
            {showCredits && (
              <motion.div
                ...
                className="absolute right-[-30px] mt-4 w-64 rounded-2xl bg-black/90 backdrop-blur-xl border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.7)] p-4 text-white"
              >
